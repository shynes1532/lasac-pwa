...
// Imágenes de los vehículos - sin extensión, la detectamos automáticamente
const imagenesBase = ['mobi', 'argo', 'cronos', 'pulse', 'fastback', 'fiat600', 'strada', 'toro', 'titano', 'fiorino'];

// Colores fallback
const colorFallback = {
  mobi: 'from-red-500 to-red-600',
  argo: 'from-gray-700 to-gray-800',
  cronos: 'from-gray-600 to-gray-700',
  pulse: 'from-slate-200 to-slate-300',
  fastback: 'from-gray-500 to-gray-600',
  fiat600: 'from-teal-600 to-teal-700',
  strada: 'from-red-600 to-red-700',
  toro: 'from-gray-400 to-gray-500',
  titano: 'from-red-700 to-red-800',
  fiorino: 'from-slate-100 to-slate-200'
};
...
const planesDetalle = [
  {
    ...
    suscripcion: 232399,
    cuotas: [
      { rango: 'Cuota 2', valor: 236341 },
      { rango: 'Cuotas 3-11', valor: 252982 },
      { rango: 'Cuota 12', valor: 259990 },
      { rango: 'Cuotas 13-18', valor: 283459 },
      { rango: 'Cuota 19', valor: 252225 },
      { rango: 'Cuotas 20-24', valor: 266949 },
      { rango: 'Cuotas 25-84', valor: 252225 },
    ],
    adjudicacion: 'Cuotas 6 y 12 + 30% (AE + 10%)',
    diferimientos: 'Cuotas 1 a 12: 20% / Cuotas 13 a 18: 10%',
    subite: true
  },
  {
    id: 'fiorino-70-30',
    modelo: 'fiorino',
    nombre: 'FIORINO ENDURANCE 1.3 MT',
    codigo: 'FO1',
    plan: '70/30',
    condicion: 'B70',
    tipo: 'SIN DIFERIMIENTOS',
    valorMovil: 26660633,
    suscripcion: 275206,
    cuotas: [
      { rango: 'Cuota 2', valor: 319661 },
      { rango: 'Cuotas 3-11', valor: 319661 },
      { rango: 'Cuota 12', valor: 339390 },
      { rango: 'Cuota 13', valor: 319661 },
      { rango: 'Cuotas 14-84', valor: 264118 },
    ],
    adjudicacion: 'Cuotas 4, 6 y 12 + 30% (AE)',
    diferimientos: 'SIN DIFERIMIENTOS',
    subite: true
  },
  {
    id: 'argo-70-30',
    modelo: 'argo',
    nombre: 'ARGO DRIVE 1.3L MT',
    codigo: 'AR2',
    plan: '70/30',
    condicion: 'B70',
    tipo: 'SIN DIFERIMIENTOS',
    ...
    suscripcion: 279596,
    cuotas: [
      { rango: 'Cuota 2', valor: 296579 },
      { rango: 'Cuotas 3-11', valor: 296579 },
      { rango: 'Cuota 12', valor: 314883 },
      { rango: 'Cuota 13', valor: 296579 },
  ...
  },
  {
    id: 'cronos-70-30',
    modelo: 'cronos',
    nombre: 'CRONOS DRIVE 1.3L MT5 PACK PLUS',
    codigo: 'DP1',
    plan: '70/30',
    condicion: 'B72',
    tipo: 'SIN DIFERIMIENTOS',
    ...
    suscripcion: 347603,
    cuotas: [
      { rango: 'Cuota 2', valor: 347362 },
      { rango: 'Cuotas 3-11', valor: 347362 },
      { rango: 'Cuota 12', valor: 370118 },
      { rango: 'Cuotas 13-19', valor: 347362 },
      { rango: 'Cuotas 20-84', valor: 304650 },
    ],
    adjudicacion: 'Cuotas 2, 4, 9, 12 + 30% (AE)',
    diferimientos: 'SIN DIFERIMIENTOS',
    subite: true
  },
  {
    ...
    suscripcion: 397261,
    cuotas: [
      { rango: 'Cuota 2', valor: 408988 },
      { rango: 'Cuotas 3-11', valor: 408988 },
      { rango: 'Cuota 12', valor: 431744 },
      { rango: 'Cuota 13', valor: 408988 },
      { rango: 'Cuotas 14-84', valor: 344921 },
    ],
    adjudicacion: 'Cuotas 6, 9, 12 + 20% (AE)',
    diferimientos: 'SIN DIFERIMIENTOS',
    subite: true
  },
  {
    ...
    suscripcion: 446919,
    cuotas: [
      { rango: 'Cuota 2', valor: 449258 },
      { rango: 'Cuotas 3-11', valor: 449258 },
      { rango: 'Cuota 12', valor: 472015 },
      { rango: 'Cuota 13', valor: 449258 },
      { rango: 'Cuotas 14-84', valor: 385192 },
    ],
    adjudicacion: 'Cuota 10 + 20% (AE + 10%)',
    diferimientos: 'SIN DIFERIMIENTOS',
    subite: true
  },
  {
    ...
    suscripcion: 344334,
    cuotas: [
      { rango: 'Cuota 2', valor: 365249 },
      { rango: 'Cuotas 3-11', valor: 365249 },
      { rango: 'Cuota 12', valor: 387792 },
      { rango: 'Cuota 13', valor: 365249 },
  ...
  },
  {
    id: 'strada-70-30',
    modelo: 'strada',
    nombre: 'STRADA FREEDOM CD 1.3 8V MT',
    codigo: 'FS1',
    plan: '70/30',
    condicion: 'B70',
    tipo: 'SIN DIFERIMIENTOS',
    ...
    suscripcion: 352274,
    cuotas: [
      { rango: 'Cuota 2', valor: 409179 },
      { rango: 'Cuotas 3-11', valor: 409179 },
      { rango: 'Cuota 12', valor: 434433 },
      { rango: 'Cuota 13', valor: 409179 },
      { rango: 'Cuotas 14-84', valor: 338082 },
    ],
    adjudicacion: 'Cuotas 6 y 12 + 35% (AE + 5%)',
    diferimientos: 'SIN DIFERIMIENTOS',
    subite: true
  },
  {
    id: 'toro-70-30',
    modelo: 'toro',
    nombre: 'TORO FREEDOM 1.3T AT6 4X2',
    codigo: 'NT1',
    plan: '70/30',
    condicion: 'B71',
    tipo: 'CUOTA VARIABLE',
    ...
    suscripcion: 399272,
    cuotas: [
      { rango: 'Cuota 2', valor: 475903 },
      { rango: 'Cuotas 3-11', valor: 507706 },
      { rango: 'Cuota 12', valor: 515299 },
      { rango: 'Cuota 13', valor: 425763 },
      { rango: 'Cuotas 14-18', valor: 445460 },
      { rango: 'Cuotas 19-42', valor: 425763 },
      { rango: 'Cuotas 43-84', valor: 425763 },
    ],
    adjudicacion: 'Cuotas 4, 6 y 12 + 30% (AE)',
    diferimientos: 'Cuotas 1 a 12: 10%',
    subite: true
  },
  {
    id: 'fastback-70-30',
    ...
    suscripcion: 382878,
    cuotas: [
      { rango: 'Cuota 2', valor: 416760 },
      { rango: 'Cuotas 3-11', valor: 444611 },
      { rango: 'Cuota 12', valor: 451260 },
      { rango: 'Cuota 13', valor: 372851 },
      { rango: 'Cuotas 14-18', valor: 390101 },
      { rango: 'Cuotas 19-42', valor: 372851 },
  ...
  },
  {
    ...
    suscripcion: 421864,
    cuotas: [
      { rango: 'Cuota 2', valor: 487409 },
      { rango: 'Cuotas 3-11', valor: 526612 },
      { rango: 'Cuota 12', valor: 529034 },
      { rango: 'Cuotas 13-18', valor: 549846 },
      { rango: 'Cuota 19', valor: 476267 },
      { rango: 'Cuotas 20-42', valor: 455454 },
      { rango: 'Cuotas 43-84', valor: 455454 },
    ],
    adjudicacion: 'Cuotas 4, 6 y 12 + 40% (AE)',
    diferimientos: 'Cuotas 1 a 12: 10%',
    subite: true
  },
];
...
const novedades = [
  {
    id: 1,
    fecha: '04 Feb 2026',
    titulo: '🚀 Nuevo Fiat 600 Hybrid ya disponible',
    descripcion: 'Llegó el nuevo Fiat 600 con tecnología híbrida. Motor 1.2 de 145 CV con consumo reducido. ¡Vení a conocerlo!',
    imagen: 'fiat600',
    destacado: true
  },
  {
    id: 2,
    fecha: '01 Feb 2026',
    titulo: '📋 Nuevos Planes de Ahorro Febrero',
    descripcion: 'Actualizamos todos los planes con nuevas condiciones. Cronos desde $347.000 de cuota. Consultá el simulador.',
    imagen: 'cronos',
    destacado: true
  },
  {
    ...
    descripcion: 'Más de 25 unidades con precios especiales. Cronos, Fastback, Pulse y más. Entrega inmediata.',
    imagen: 'fastback',
    destacado: false
  },
  {
    id: 4,
    fecha: '20 Ene 2026',
    titulo: '🔧 Promo Service de Verano',
    descripcion: 'Revisión de aire acondicionado + control de niveles gratis con cualquier service. Válido hasta el 28/02.',
    imagen: 'strada',
    destacado: false
  },
];
...
const Calendario = ({ fechaSeleccionada, onSeleccionar }) => {
  ...
  const esHabil = (fecha) => fecha && fecha.getDay() !== 0;
  const esPasado = (fecha) => fecha && fecha < hoy && fecha.toDateString() !== hoy.toDateString();
  const esSeleccionado = (fecha) => fecha && fechaSeleccionada && fecha.toDateString() === fechaSeleccionada.toDateString();
    ...
    <div className="bg-white/5 rounded-xl p-3 border border-white/10">
      ...
      <div className="grid grid-cols-7 gap-1">
        {dias.map((fecha, i) => (
          <button
            key={i}
            disabled={!fecha || !esHabil(fecha) || esPasado(fecha)}
            ...
            className={`aspect-square rounded-lg text-xs flex items-center justify-center transition-all
              ${!fecha ? 'invisible' : ''}
              ${fecha && !esHabil(fecha) ? 'text-white/20' : ''}
...
export default function LasacApp() {
  ...
  const [turno, setTurno] = useState({
    nombre: '', telefono: '', email: '', patente: '', modelo: '', km: '',
    servicio: '', sucursal: '', fecha: null, horario: '', comentarios: ''
  });
  ...
  const enviarTurno = () => {
    ...
    const servicioInfo = servicios.find(s => s.nombre === turno.servicio);
      ...
      <main className="max-w-lg mx-auto p-3">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-r from-red-600 to-red-800 rounded-2xl p-6 text-center relative overflow-hidden">
              ...
              <div className="flex gap-2 justify-center flex-wrap relative">
                <button onClick={() => setSeccion('oportunidades')} className="px-6 py-2 bg-white text-red-600 rounded-full font-bold text-sm">
                  🔥 Oferta del Mes
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                <div key={item.id} onClick={() => setSeccion(item.id)} className="bg-white/5 rounded-xl p-3 active:scale-95 transition-all border border-white/10 text-center">
                  <div className={`w-10 h-10 mx-auto rounded-lg bg-gradient-to-r ${item.color} flex items-center justify-center text-xl mb-2`}>
                    {item.icon}
                  </div>
          ...
          <div>
            ...
            <div className="flex gap-2 mb-4 overflow-x-auto pb-2 -mx-3 px-3">
              {['todos', 'autos', 'suv', 'pickups', 'utilitarios'].map(cat => (
                <button key={cat} onClick={() => setFiltro(cat)} className={`px-3 py-1.5 rounded-full text-xs capitalize whitespace-nowrap ${filtro === cat ? 'bg-red-600' : 'bg-white/10'}`}>
                  {cat}
                </button>
              ))}
            </div>
        ...
        {seccion === 'simulador' && (
          <div>
            ...
            {!planSeleccionado ? (
              ...
              <div className="space-y-4">
                {/* Botón volver */}
                <button onClick={() => setPlanSeleccionado(null)} className="text-sm text-white/60 flex items-center gap-1">
                  ← Volver a planes
                </button>
                  ...
                  <div className="p-4">
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-4">
                      <div className="bg-black/20 rounded-lg p-2">
                        ...
                        <p className="font-bold text-sm">{planSeleccionado.plan}</p>
                      </div>
                      <div className="bg-black/20 rounded-lg p-2">
                        <p className="text-[10px] text-white/50">Condición</p>
                        <p className="font-bold text-sm">{planSeleccionado.condicion}</p>
                      </div>
                      <div className="bg-black/20 rounded-lg p-2 col-span-2">
                        <p className="text-[10px] text-white/50">Valor Móvil (sin IVA)</p>
                        <p className="font-bold text-green-400">{formatPrecio(planSeleccionado.valorMovil)}</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2 text-xs">
                      <div className="bg-blue-500/20 rounded-lg p-3">
                        <p className="text-white/60">🎯 Adjudicación</p>
                        <p className="font-bold">{planSeleccionado.adjudicacion}</p>
                      </div>
                      <div className="bg-amber-500/20 rounded-lg p-3">
                        <p className="text-white/60">📊 Diferimientos</p>
                        <p className="font-bold">{planSeleccionado.diferimientos}</p>
                      </div>
                      {planSeleccionado.subite && (
                        <div className="bg-green-500/20 rounded-lg p-3">
                          <p className="font-bold">✅ Opción SUBITE disponible</p>
                        </div>
                      )}
                    </div>

                    {/* Botón consultar */}
                    <button onClick={() => consultarPlan(planSeleccionado)} className="w-full mt-4 py-3 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl font-bold">
                      📞 Consultar este Plan
                    </button>
                  </div>
                </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                ...
                <div className="space-y-2">
                  ...
                  <select id="siniestro-tipo" className="w-full p-2.5 rounded-lg bg-slate-800 border border-white/20 text-sm">
                    ...
                    <option value="Colisión">Colisión / Choque</option>
                    <option value="Robo total">Robo total</option>
                    <option value="Robo parcial">Robo parcial</option>
                    <option value="Granizo">Daño por granizo</option>
              ...
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button type="button" onClick={(e) => { document.querySelectorAll('[data-suc]').forEach(el => el.classList.remove('bg-red-600')); e.currentTarget.classList.add('bg-red-600'); e.currentTarget.dataset.selected = 'Ushuaia'; }} data-suc className="p-3 rounded-lg text-left bg-white/5 border border-white/10">
                    <div className="font-bold text-sm">Ushuaia</div>
                    <div className="text-[10px] text-white/60">Piedrabuena 256</div>
                  </button>
                  <button type="button" onClick={(e) => { document.querySelectorAll('[data-suc]').forEach(el => el.classList.remove('bg-red-600')); e.currentTarget.classList.add('bg-red-600'); e.currentTarget.dataset.selected = 'Río Grande'; }} data-suc className="p-3 rounded-lg text-left bg-white/5 border border-white/10">
                    <div className="font-bold text-sm">Río Grande</div>
                    <div className="text-[10px] text-white/60">San Martín 2599</div>
                  </button>
                </div>
              </div>
              ...
              <button 
                onClick={() => {
                  ...
                  const msg = `🛡️ *ATENCIÓN DE SINIESTRO*%0A%0A` +
                    `👤 *TITULAR*%0ANombre: ${nombre}%0ADNI: ${dni}%0ATel: ${telefono}%0A%0A` +
                    `🚗 *VEHÍCULO*%0A${marca} ${modelo} ${anio}%0APatente: ${patente}%0A%0A` +
                    `🏢 *SEGURO*%0AAseguradora: ${aseguradora}%0APóliza: ${poliza}%0AN° Siniestro: ${numSiniestro || 'Pendiente'}%0A%0A` +
                    `📋 *SINIESTRO*%0AFecha: ${fecha}%0ATipo: ${tipo}%0ADescripción: ${descripcion}%0A%0A` +
                    `📍 Sucursal: ${sucursal}`;
              ...
              <div className="bg-white/5 rounded-xl p-4 border border-white/10 text-center">
                ...
                <a href="tel:+5492901559933" className="inline-block px-4 py-2 bg-green-600 rounded-full text-sm font-bold">
                  📞 Llamar ahora
                </a>
              </div>
            </div>
        ...
        {seccion === 'atencion' && (
          <div>
            ...
            <p className="text-white/60 text-xs mb-4">Consultas, reclamos y sugerencias</p>

            <div className="space-y-4">
              {/* Tipo de contacto */}
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                <h3 className="font-bold text-sm mb-3">📝 ¿En qué podemos ayudarte?</h3>
                <div className="grid grid-cols-1 gap-2">
                  {[
                    { id: 'consulta', icon: '❓', titulo: 'Consulta', desc: 'Tengo una pregunta' },
                    { id: 'reclamo', icon: '⚠️', titulo: 'Reclamo', desc: 'Quiero reportar un problema' },
                    { id: 'sugerencia', icon: '💡', titulo: 'Sugerencia', desc: 'Tengo una recomendación' },
                    { id: 'felicitacion', icon: '⭐', titulo: 'Felicitación', desc: 'Quiero destacar una buena atención' },
                  ].map(tipo => (
                    <button 
                      key={tipo.id}
                      type="button"
                      onClick={(e) => { 
                        document.querySelectorAll('[data-tipo-atencion]').forEach(el => el.classList.remove('bg-sky-600', 'border-sky-500'));
                        e.currentTarget.classList.add('bg-sky-600', 'border-sky-500');
                        document.getElementById('atencion-tipo').value = tipo.titulo;
                      }}
                      data-tipo-atencion
                      className="flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-white/10 text-left transition-all"
                    >
                      <span className="text-2xl">{tipo.icon}</span>
                      <div>
                        <div className="font-bold text-sm">{tipo.titulo}</div>
                        <div className="text-[10px] text-white/60">{tipo.desc}</div>
                      </div>
                    </button>
                  ))}
                </div>
                <input type="hidden" id="atencion-tipo" />
              </div>
              ...
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                ...
                <div className="space-y-2">
                  <input placeholder="Nombre completo *" id="atencion-nombre" className="w-full p-2.5 rounded-lg bg-white/5 border border-white/20 text-sm" />
                  <input placeholder="Teléfono *" id="atencion-telefono" className="w-full p-2.5 rounded-lg bg-white/5 border border-white/20 text-sm" />
                  <input placeholder="Email" id="atencion-email" type="email" className="w-full p-2.5 rounded-lg bg-white/5 border border-white/20 text-sm" />
                </div>
              </div>
              ...
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                ...
                <select id="atencion-area" className="w-full p-2.5 rounded-lg bg-slate-800 border border-white/20 text-sm">
                  <option value="">Seleccionar área *</option>
                  <option value="Ventas 0KM">Ventas 0KM</option>
                  <option value="Plan de Ahorro">Plan de Ahorro</option>
                  <option value="Service / Posventa">Service / Posventa</option>
              ...
              {/* Si tiene vehículo relacionado */}
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                <h3 className="font-bold text-sm mb-3">🚗 Vehículo (opcional)</h3>
                <div className="grid grid-cols-2 gap-2">
                  <input placeholder="Modelo" id="atencion-modelo" className="p-2.5 rounded-lg bg-white/5 border border-white/20 text-sm" />
                  <input placeholder="Patente" id="atencion-patente" className="p-2.5 rounded-lg bg-white/5 border border-white/20 text-sm uppercase" />
                </div>
              </div>
              ...
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                ...
                <textarea 
                  placeholder="Contanos en detalle tu consulta, reclamo o sugerencia... *" 
                  id="atencion-mensaje" 
                  rows={5} 
                  className="w-full p-2.5 rounded-lg bg-white/5 border border-white/20 text-sm resize-none"
                />
              </div>
              ...
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button type="button" onClick={(e) => { document.querySelectorAll('[data-suc-atencion]').forEach(el => el.classList.remove('bg-sky-600')); e.currentTarget.classList.add('bg-sky-600'); }} data-suc-atencion data-sucursal="Ushuaia" className="p-3 rounded-lg text-left bg-white/5 border border-white/10">
                    <div className="font-bold text-sm">Ushuaia</div>
                  </button>
                  <button type="button" onClick={(e) => { document.querySelectorAll('[data-suc-atencion]').forEach(el => el.classList.remove('bg-sky-600')); e.currentTarget.classList.add('bg-sky-600'); }} data-suc-atencion data-sucursal="Río Grande" className="p-3 rounded-lg text-left bg-white/5 border border-white/10">
                    <div className="font-bold text-sm">Río Grande</div>
                  </button>
                </div>
              </div>
              ...
              <button 
                onClick={() => {
                  const tipo = document.getElementById('atencion-tipo')?.value || 'Consulta';
                  const nombre = document.getElementById('atencion-nombre')?.value || '';
                  const telefono = document.getElementById('atencion-telefono')?.value || '';
                  const email = document.getElementById('atencion-email')?.value || '';
                  const area = document.getElementById('atencion-area')?.value || '';
                  const modelo = document.getElementById('atencion-modelo')?.value || '';
                  const patente = document.getElementById('atencion-patente')?.value || '';
                  const mensaje = document.getElementById('atencion-mensaje')?.value || '';
                  const sucursal = document.querySelector('[data-suc-atencion].bg-sky-600')?.dataset?.sucursal || '';
                  
                  const msg = `💬 *ATENCIÓN AL CLIENTE*%0A%0A` +
                    `📝 Tipo: *${tipo}*%0A%0A` +
                    `👤 *DATOS*%0ANombre: ${nombre}%0ATel: ${telefono}%0AEmail: ${email || 'No indicado'}%0A%0A` +
                    `🏢 Área: ${area}%0A📍 Sucursal: ${sucursal}%0A` +
                    (modelo || patente ? `🚗 Vehículo: ${modelo} ${patente}%0A%0A` : '%0A') +
                    `✍️ *MENSAJE*%0A${mensaje}`;
                  
                  window.open(`https://wa.me/5492964610900?text=${msg}`, '_blank');
                }}
                className="w-full py-4 rounded-xl font-bold text-lg bg-gradient-to-r from-sky-600 to-sky-700 active:scale-95 transition-all"
              >
                📱 Enviar por WhatsApp
              </button>
              ...
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                ...
                <div className="flex gap-2 justify-center">
                  <a href="tel:+5492964610900" className="px-4 py-2 bg-green-600 rounded-full text-sm font-bold">
                    📞 Llamar
                  </a>
                  <a href="mailto:atencion@lasac.com.ar" className="px-4 py-2 bg-blue-600 rounded-full text-sm font-bold">
                    ✉️ Email
                  </a>
                </div>
              </div>
          ...
          <div>
            ...
            {enviado ? (
              <div className="bg-green-500/20 rounded-xl p-6 text-center border border-green-500/30">
                ...
                <button onClick={() => { setEnviado(false); setTurno({nombre:'',telefono:'',email:'',patente:'',modelo:'',km:'',servicio:'',sucursal:'',fecha:null,horario:'',comentarios:''}); }} className="px-4 py-2 bg-white/10 rounded-lg text-sm">
                  Nueva Solicitud
                </button>
              </div>
            ) : (
              <div className="space-y-4">
                  ...
                  {turno.fecha && (
                    <div className="mt-3">
                      ...
                      <div className="grid grid-cols-4 gap-1">
                        {horarios.map(h => (
                          <button key={h} onClick={() => setTurno({...turno, horario: h})} className={`p-1.5 rounded text-[10px] ${turno.horario === h ? 'bg-red-600' : 'bg-white/10'}`}>{h}</button>
                        ))}
                      </div>
                    </div>
                  )}
                ...
                <button onClick={enviarTurno} disabled={!turno.nombre || !turno.telefono || !turno.patente || !turno.modelo || !turno.km || !turno.servicio || !turno.sucursal} className={`w-full py-4 rounded-xl font-bold text-lg ${turno.nombre && turno.telefono && turno.patente && turno.modelo && turno.km && turno.servicio && turno.sucursal ? 'bg-gradient-to-r from-green-600 to-green-700' : 'bg-white/20 text-white/50'}`}>
                  📱 Enviar por WhatsApp
                </button>
              </div>
            )}
        ...
        {seccion === 'contacto' && (
          <div>
            ...
            <div className="space-y-2">
              <a href="https://wa.me/5492964465270" className="flex items-center gap-3 bg-white/5 rounded-xl p-4 border border-white/10 active:scale-[0.98] transition-all">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-sm">FIAT Plan - Administración</h4>
                  <p className="text-xs text-white/60">Consultas sobre tu plan de ahorro</p>
                </div>
              ...
              <a href="https://wa.me/5492964609082" className="flex items-center gap-3 bg-white/5 rounded-xl p-4 border border-white/10 active:scale-[0.98] transition-all">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-sm">Repuestos</h4>
                  <p className="text-xs text-white/60">Consultas y pedidos de repuestos</p>
                </div>
                <span className="text-green-500 text-xl">💬</span>
              </a>
            </div>
            ...
            <div className="bg-white/5 rounded-xl p-4 mt-4 text-center border border-white/10">
              <a href="https://lasac.com.ar" target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-2 bg-gradient-to-r from-red-600 to-red-700 rounded-full font-bold text-sm">
                🌐 lasac.com.ar
              </a>
            </div>
          </div>
